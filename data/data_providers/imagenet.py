...
class ImagenetDataProvider(DataProvider):
    ...
    def __init__(self, save_path=None, train_batch_size=256, test_batch_size=512, valid_size=None, n_worker=32,
        ...
        self.valid_size = valid_size  # validation set size
    ...
    def build_train_transform(self, image_size=None, print_log=True, auto_augment='rand-m9-mstd0.5'):
        ...
        if print_log:
            print('Color jitter: %s, resize_scale: %s, valid_set_size: %s' %
                  (self.distort_color, self.resize_scale, self.valid_size))
        ...
        aa_params['interpolation'] = str_to_interp_mode('bicubic')
