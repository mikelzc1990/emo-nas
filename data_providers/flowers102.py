...
class Flowers102DataProvider(DataProvider):
    ...
    def __init__(self, save_path=None, train_batch_size=32, test_batch_size=100, valid_size=1000, n_worker=2,
                 resize_scale=1.0, distort_color=None, image_size=224, num_replicas=None, rank=None):
